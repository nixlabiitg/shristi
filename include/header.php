    ...
    <div class="th-menu-wrapper">
        <div class="th-menu-area text-center">
            ...
            <div class="mobile-logo">
                <a href="index"><img src="assets/img/logo.svg" alt="Donat"></a>
            </div>
                ...
                <ul>
                    ...
                    <li class="menu-item-has-children">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li><a href="collab">Partner & Collaboration</a></li>
                ...
                <div class="row justify-content-center justify-content-lg-between align-items-center gy-2">
                    <div class="col-auto d-none d-lg-block">
                        <div class="header-logo">
                            <a href="index"><img src="assets/img/logo/logo-dark.png" style="height: 90px; width: 90px;" alt="Donat"></a>
                        </div>
                    </div>
                        ...
                        <div class="info-card-wrap">
                            <div class="info-card">
                                ...
                                <div class="box-content">
                                    ...
                                    <h4 class="box-title">Silpukhuri, Guwahati - 781003</h4>
                                </div>
                            </div>
                            <div class="info-card">
                                <div class="box-icon">
                            ...
                            <div class="info-card">
                                ...
                                <div class="box-content">
                                    ...
                                    <h6 class="box-title">
                                        <a href="mailto:sshristiinternationalsociety555@gmail.com">
                                            <span style="display:block;">sshristiinternational</span>
                                            <span style="display:block;">society555@gmail.com</span>
                                        </a>
                                    </h6>
                ...
                <div class="menu-area">
                    <div class="menu-area-wrap">
                        <div class="col-auto d-inline-block d-lg-none">
                            <div class="header-logo">
                                <a href="index"><img src="assets/img/logo-white.svg" alt="Donat"></a>
                            </div>
                        </div>
