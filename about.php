                ...
                <div class="col-xl-5">
                    <div class="about-wrap1">
                        ...
                        <div class="btn-wrap mt-40">
                            <a href="donation" class="th-btn">Donation<i class="fas fa-arrow-up-right ms-2"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-5">
                    <div class="about-wrap1">
                        <div class="title-area mb-30">
                            ...
                            <p class="">At Shristi International Society, our mission is to foster a compassionate,
                                inclusive, and empowered society by addressing critical social challenges and promoting
                                cultural, educational, and environmental awareness.</p>
                        </div>
                        <div class="checklist style2">
                            <ul>
                                <li data-theme-color="#FF5528">Support underprivileged
                                        communities by improving health, education, and living conditions</li>
                                <li data-theme-color="#122F2A">Empower women to become active
                                        contributors to social development</li>
                                <li data-theme-color="#FF5528">Preserve and promote India's rich
                                        heritage through art, culture, and classical music</li>
                                <li data-theme-color="#122F2A">Encourage environmental
                                        responsibility and sustainability</li>
                                <li data-theme-color="#FF5528">Unite individuals and communities
                                        to collaborate for collective well-being and long-term impact</li>
                            </ul>
                        </div>
                        <div class="btn-wrap mt-40">
                            <a href="donation" class="th-btn">Donation<i class="fas fa-arrow-up-right ms-2"></i></a>
