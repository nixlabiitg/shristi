...
<!-- Mirrored from html.themehour.net/donat/demo/donate-now.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 23 Oct 2025 08:32:52 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>Donat - Charity & Donation HTML Template - Donate Now</title>
                        ...
                        <ul class="sub-menu">
                            ...
                            <li class="menu-item-has-children">
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li><a href="home-4-op.html">Home Four</a></li>
                                    <li><a href="home-5-op.html">Home Five</a></li>
                                </ul>
                            </li>
                            <li class="menu-item-has-children">
                                <a href="#">RTL</a>
                                <ul class="sub-menu">
                                    ...
                                    <li><a href="home-4-rtl.html">Home Four</a></li>
                                    <li><a href="home-5-rtl.html">Home Five</a></li>
                                </ul>
                            </li>
                        </ul>
                    </li>
                        ...
                        <div class="info-card-wrap">
                            <div class="info-card">
                                ...
                                <div class="box-content">
                                    ...
                                    <h4 class="box-title"><a href="https://www.google.com/maps">Newyork City, USA</a></h4>
                                </div>
                            </div>
                            <div class="info-card">
                                <div class="box-icon">
                                                ...
                                                <div class="row gy-4">
                                                    <div class="col-lg-4">
                                                        <div class="mega-menu-box">
                                                            ...
                                                            <h3 class="mega-menu-title"><a href="index.html">Home One</a></h3>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4">
                                                        <div class="mega-menu-box">
                                                            ...
                                                            <h3 class="mega-menu-title"><a href="home-2.html">Home Two</a></h3>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4">
                                                        <div class="mega-menu-box">
                                                            ...
                                                            <h3 class="mega-menu-title"><a href="home-3.html">Home Three</a></h3>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4">
                                                        <div class="mega-menu-box">
                                                            ...
                                                            <h3 class="mega-menu-title"><a href="home-4.html">Home Four</a></h3>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4">
                                                        <div class="mega-menu-box">
                                                            ...
                                                            <h3 class="mega-menu-title"><a href="home-5.html">Home Five</a></h3>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
            ...
            <div class="row gx-40">
                <div class="col-xxl-8 col-lg-7">
                    <div class="donation-form-v1">
                        ...
                        <form action="https://html.themehour.net/donat/demo/mail.php" method="POST" class="contact-form ajax-contact">
...
<!-- Mirrored from html.themehour.net/donat/demo/donate-now.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 23 Oct 2025 08:32:53 GMT -->
</html>