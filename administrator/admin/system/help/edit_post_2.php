...
if (isset($_POST['update_post'])) {
    ...
    if (!empty($_FILES['post_img']['name'])) {
        ...
        if (update_post($_GET['post_id'], $row['post_img'], $_FILES['post_img']['name'], $_FILES['post_img']['tmp_name'], $_POST['cate_id'], $_POST['sub_cate_id'], $_POST['post_header'], $_POST['posted_by'], $_POST['post_desc'], $_POST['labels']) == "2")
            print "<script>window.location.href='publish.php'</script>";
        else if (update_post($_GET['post_id'], $row['post_img'], $_FILES['post_img']['name'], $_FILES['post_img']['tmp_name'], $_POST['cate_id'], $_POST['sub_cate_id'], $_POST['post_header'], $_POST['posted_by'], $_POST['post_desc'], $_POST['labels']) == "4")
        ...
        if (update_post($_GET['post_id'], 1, 1, 1, $_POST['cate_id'], $_POST['sub_cate_id'], $_POST['post_header'], $_POST['posted_by'], $_POST['post_desc'],$_POST['labels']))
            print "<script>window.location.href='publish.php'</script>";
        else
            $msg = "Something wrong while adding";
    }
                            ...
                            <form method="POST" autocomplete="off" enctype="multipart/form-data">
                                ...
                                <div class="row clearfix">
                                    <div class="col-sm-12">
                                        ...
                                        <input type="text" class="form-control" name="labels" value="<?php !empty($row['labels'])? print $row['labels']: print '';?>" required> 
                                    </div> 
                                </div>
