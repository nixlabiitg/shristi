                                            ...
                                            if ($con) {
                                                ...
                                                if($pre->execute()){
                                                    ...
                                                    while ($row = $pre->fetch(PDO::FETCH_ASSOC)){
                                                        ...
                                                        print "<td><a href=\"changes_post_status_2.php?post_id=$row[post_id]\">Publish</a></td>";
                                                        print "<td><a href=\"edit_post_2.php?post_id=$row[post_id]\"><i class=\"glyphicon glyphicon-edit\"></i></a></td>";
                                                        print "</tr>";
                                                    }
                                                }
                                            }
